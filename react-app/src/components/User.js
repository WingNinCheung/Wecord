      ...
      <div className="userPage">
        <div className="profileDiv">
          ...
          <ul className="userProfile1">
            ...
            {((friendsState[yourId] == undefined) && (yourId !== parseInt(userId))) ? <button onClick={addFriendButton} className="friendBtn">Add Friend</button> :
              (yourId !== parseInt(userId)) && <button onClick={removeFriendButton} className="friendBtn">Unfriend</button>}
